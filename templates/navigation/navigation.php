<?php
    ...
    if (isset($_SESSION['user'])) {
        ...
        $role = $user->getRole($userInfo['role']); 
        ...
        echo "<div class='navigation bg-white relative'>
                <div class='cover-photo container relative'>
        ...
        <div class='edit-cover'>
                ...
                <div class='user-info container'>
                    ...
                    <span class='user-role'>{$role['role_title']}</span>
                ...
                <div class='user-tabs'>
                    <div class='container'>
                        <div class='row'>
                            <div class='tab-item'>
                                <a onclick='featureDisable()' href='#'>Photos</a>
                            </div>
                        </div>
                    </div>
                </div>
